...
val init : (Stdint.Int8.t * bool) Memory.t
(** [init] returns a memory with all memory addresses initialized to 0*)

val pp_memory : (Stdint.Int8.t * bool) Memory.t -> unit
...
val update_memory : Memory.key -> int -> (Stdint.Int8.t * bool) Memory.t -> (Stdint.Int8.t * bool) Memory.t
